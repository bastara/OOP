...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Размер вектора v2: " + v2.toString() + ": " + v2.getSize());
        System.out.println();
        ...
        try {
            ...
            System.out.println("Координаты вектора v6(конструктор new Vector(0, c1)):" + v6.toString());
            System.out.println();
        } catch (IllegalArgumentException e) {
            System.out.println("EXCEPTIONS! Размерность прстранства 0 или отрицательная. Вектор не создан");
            System.out.println();
        ...
        System.out.println("Размер вектора v1: " + v1.toString());
        System.out.println("Размер вектора v4: " + v4.toString());
        v1.addVector(v4);
        System.out.println("Координаты вектора v1(сложение v1 и v4):" + v1.toString());
        System.out.println();

        //b.	Вычитание из вектора другого вектора
        System.out.println("Размер вектора v4: " + v4.toString());
        System.out.println("Размер вектора v2: " + v2.toString());
        v4.subtractionVector(v2);
        System.out.println("Координаты вектора v4(вычитание из v4 вектора v2): " + v4.toString());
        System.out.println();

        //c.	Умножение вектора на скаляр
        double[] c5 = {1, -4, 1, 1};
        Vector v5 = new Vector(c5);
        v5.getMultiplicationVectorByScalar(4);
        System.out.println("Координаты вектора v7(скалярное произведение на 4): " + v5.toString());
        System.out.println();


        //d.	Разворот вектора (умножение всех компонент на -1)
        v5.invertVector();
        System.out.println("Разворот вектора v7 и его новые координаты: " + v5.toString());
        System.out.println();
        ...
        System.out.println("Сложение векторов v5-" + v5.toString() + " и v2-" + v2.toString());
        Vector v10 = Vector.sumVector(v5, v2);
        System.out.println("Координаты вектора v10:" + v10.toString());
        System.out.println();

        //b.	Вычитание векторов
        System.out.println("Вычитание из v5-" + v5.toString() + " вектора v2-" + v2.toString());
        Vector v11 = Vector.difVector(v5, v2);
